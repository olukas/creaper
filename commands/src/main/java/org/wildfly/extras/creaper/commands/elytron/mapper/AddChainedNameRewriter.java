...
public class AddChainedNameRewriter extends AbstractAddNameRewriter {

    private AddChainedNameRewriter(Builder builder) {
        super(builder);
    }
    ...
    public void apply(OnlineCommandContext ctx) throws Exception {
        ...
        Address aggregateNameRewriterAddress = Address.subsystem("elytron")
                .and("chained-name-rewriter", name);
        if (replaceExisting) {
