...
public final class AddCustomNameRewriter extends AbstractAddCustom {

    protected AddCustomNameRewriter(Builder builder) {
        super(builder);
    }

    @Override
    protected String getCustomTypeName() {
        return "custom-name-rewriter";
    }
